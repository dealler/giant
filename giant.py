...
# getting the employees and removing the duplicated with set
def remove_duplicates(employees):
	unique_employees = set()
	for employee in employees:
		unique_employees.add(tuple(employee.items()))
	return [dict(u) for u in unique_employees]
...
def create_pairs(employees, res):
	...
	employees_size = len(shuffled_employees)
	for i in range(1, employees_size):
